...
module.exports = function(router, passport, allowUpload){
  ...
  router.use('/tasks/add', require(root_dir + '/api/tasks/add.js'));
  router.use('/tasks/delete', require(root_dir + '/api/tasks/delete.js'));
  router.use('/tasks/edit', require(root_dir + '/api/tasks/edit.js'));
  router.use('/tasks/list', require(root_dir + '/api/tasks/list.js'));
  ...
  router.get('/pages/tasks', function(req, res) {
