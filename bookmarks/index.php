...
<link rel="shortcut icon" href="//www.jonpicchietti.com/favicon.png" />
<link rel="stylesheet" href="//www.jonpicchietti.com/css/bookmarks.css" />
<script>
function $(id){
...
folders:<?php include("include_folders.txt"); ?>,
	...
	makeMark:function(folder,url,title,favicon){
		...
		mark.style.backgroundImage="url('//www.jonpicchietti.com/bookmarks/icons/"+favicon+"')";
	...
	makeBar:function(folder,url,title,favicon){		
		...
		mark.mousemove=function(event){
			var nextEle, prevEle, mouseRelParentX=event.pageX-marksBoxX, mouseRelParentY=event.pageY-marksBoxY;
	...
	newWindow:function(){
		window.open(BookMark.currentItem.href,"","toolbar=yes,titlebar=yes,status=yes,scrollbars=yes,location=yes,resizable=yes,menubar=yes,width="+window.innerWidth-100+",height="+window.innerHeight-100);
	},
...
<div id="menu">
	...
	<div onclick="BookMark.newWindow()">Open link in new window</div>
	<hr class="divider" />
